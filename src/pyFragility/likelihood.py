...
def score_by_level(data: CollapseData, theta: float, beta: float) -> NDArray[np.float64]:
    """Per-level score, shape ``(n_levels, 2)`` with columns ``(d/dtheta, d/dbeta)``."""
